...
def main_worker(cfg):
    ...
    datasets_cfgs += [cfg.data.val_refcoco_unc,
                      ...
                      ] if cfg.dataset == "Mixed" else [cfg.data.val]
    ...
    for epoch in range(start_epoch + 1, cfg.scheduler_config.max_epoch):
        ...
        for _loader in dataloaders[1:]:
            ...
            set_d_acc, set_OIou, set_miou = evaluate_model(epoch, cfg, model, _loader)
            ...
            if cfg.ema:
                ...
                ema_set_d_acc, ema_set_OIou, ema_set_miou = evaluate_model(epoch, cfg, model, _loader)
                model_ema.restore()
